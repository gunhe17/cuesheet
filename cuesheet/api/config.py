...
class AuthConfig(ABC):
    ...
    @property
    @abstractmethod
    def LOGIN_LOCK_SEC(self) -> int: ...


class DefaultAuthConfig(AuthConfig):
    @property
    def TOKEN_TTL_SEC(self) -> int:
        return int(os.environ.get("AUTH_TOKEN_TTL_SEC", "2592000"))

    @property
    def LOGIN_MAX_ATTEMPTS(self) -> int:
        return int(os.environ.get("AUTH_LOGIN_MAX_ATTEMPTS", "5"))

    @property
    def LOGIN_LOCK_SEC(self) -> int:
        return int(os.environ.get("AUTH_LOGIN_LOCK_SEC", "300"))
