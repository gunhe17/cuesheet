...
@typecheck
async def rewind(*, session, event_group_id, input: Input, cuesheet_id: UUID, user_id: UUID | None = None) -> Output:
    # find
    ...
    # guard
    if str(found.current_cue_id) != input.expected_cue_id or found.prev_cue_id is None:
