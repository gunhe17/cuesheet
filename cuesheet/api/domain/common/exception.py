...
from cuesheet.api.core.exception import ClientError
...
class TooManyAttemptsError(DomainClientError):
    def __init__(self, retry_after_sec: int):
        super().__init__(key="too_many_attempts", params={"seconds": retry_after_sec}, code=429)
