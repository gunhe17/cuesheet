---
paths:
  - "cuesheet/api/infrastructure/hash/**/client.py"
  - "cuesheet/api/infrastructure/token/**/client.py"
  - "cuesheet/api/infrastructure/database/**/client.py"
  - "cuesheet/api/config.py"
---
...
루트: [api/CLAUDE.md](../../../cuesheet/api/CLAUDE.md) · repo: [repository.md](repository.md)
...
- 위치: `cuesheet/api/config.py` — config는 `infrastructure/` 하위가 아니라 api 루트(여러 infra 어댑터가 공유)
