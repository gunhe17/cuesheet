---
paths:
  - "cuesheet/api/usecase/*.py"
  - "cuesheet/api/core/usecase.py"
---
...
루트: [api/CLAUDE.md](../../../cuesheet/api/CLAUDE.md) · repo: [repository.md](repository.md) · 이벤트 조정: [domain-event.md](domain-event.md)
...
> 온톨로지 · noun/verb: usecase는 행위(동사)라 action 이름도 동사 — 명사(반환 대상)로 지으면 행위라는 종류가 흐려진다. → [ontology.md](../../../cuesheet/api/.claude/documents/ontology.md)
