...
루트: [api/CLAUDE.md](../../../cuesheet/api/CLAUDE.md) · VO: [value-object.md](value-object.md) · 영속화: [repository.md](repository.md)
...
> 온톨로지 · identity: Entity는 참조로 동일(같은 id면 같은 개체, 필드가 달라도) — 값(VO, 구조 동일성)과 다른 종류라 raw `UUID id`를 지닌다. → [ontology.md](../../../cuesheet/api/.claude/documents/ontology.md)
